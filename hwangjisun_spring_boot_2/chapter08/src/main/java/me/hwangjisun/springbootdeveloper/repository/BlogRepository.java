package me.hwangjisun.springbootdeveloper.repository;
...
/*
    ...
    블로그 글 작성을 위한 API 구현하기
        구현 과정 :
            ...
            Controller 클래서에서 사용할 method 구현,
            API를 실제로 테스트 할겁니다.
        ...
        서비스 메서드 코드 작성
            ...
            DTO(Data Transfer Object) : 계층끼리 데이터를 교환하기 위해 사용되는 객체
            DAO는 데이터베이스와 연결되고 데이터를 조회하고 수정하는데 사용되는 객체라 비교가 필요합니다.
            DAO의 경우에는 데이터 수정 관련된 로직이 포함되지만 DTO는 단순하게 데이터를 옮기기 위해 사용되는 전달자 역할
