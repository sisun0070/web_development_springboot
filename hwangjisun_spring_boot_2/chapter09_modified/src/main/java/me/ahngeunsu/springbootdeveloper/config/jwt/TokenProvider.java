...
public class TokenProvider {
    ...
    public String generateToken(User user, Duration expiredAt) {
        Date now = new Date();
        // 빨간줄이 뜨는 상태는 아직 정의되지 않았기 때문입니다. -> 바로 밑에 정의할 예정
...
/*
    ...
    3. getAuthentication() :
        ...
        getClaims()를 호출, 클레임 정보를 반홚받아 사용자 이메일이 들어있는 토큰 제목
        sub와 토큰 기반으로 인증 정보를 생성
        이때, UserPasswordAuthenticationoToken의 첫 argument로 들어가는 User는
    ...
    4. getUserId() :
        ...
        토큰을 복호화한 다음 클레임이 가져오는 private getClaim()를 호출,
