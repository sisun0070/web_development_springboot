...
public class ExampleController {
    ...
    public String thymeleafExample(Model model) {
        ...
        // id 1L, 이름에 홍길동, 나이가 11 취미에 운동, 독서를 입력하세요
...
/*
    ...
    모델 역할 살펴보면
        ...
        컨트롤러 모델을 통해서(앞으로 자주 쓸거다) 데이터를 설정하고,
        모델은 뷰로 해당 데이터를 전달해서 키에 맞는 데이터를 뷰에서 조회할 수 있게 만들어줍니다.

        즉, 모델은 컨트롤러와 뷰와 중간다리 역할을 해준다고 생각하시켠 됩니다.
                                                    "person" id: 1
...
컨트롤러(Controller)---------------------->           hobbies : ["운동", "독서"] -------------------> 뷰(View)
    ...
    다하면 src/main/resources/templates 디렉토리에 example.html을 만들겁니다
