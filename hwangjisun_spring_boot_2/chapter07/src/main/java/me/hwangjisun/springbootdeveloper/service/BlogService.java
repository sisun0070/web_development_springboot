package me.hwangjisun.springbootdeveloper.service;
...
import me.hwangjisun.springbootdeveloper.repository.BlogRepository;
...
public class BlogService {
    ...
    /*
        ...
        -> 글을 생성한는 서비스 계층에서의 코드 작성이 완료

        -> 컨트롤러 메서드 코드 작성하기
            URL에 매핑하기 위한 컨트롤러 메서드르 추가할겁니다. -> 컨트롤러 메서드 구현 자체는 한적있는데,
            컨트롤러 메서드에는 URL 매핑 애너테이션이
            @PostMapping
            @GetMapping
            @PutMapping
            @DeleteMapping 등을 사용할 수 있습니다.
            이름에서 유추할 수 있듯 각 애너테이션들을 HTTP 메서드와 대응합니다.

            /api/articles에 POST 요청이 들어오면 @PostMapping 을 이용해 요청을 매핑한 뒤,
    ...
    /*
        ...
        이제 BlogApiControlloer.java 이동하겠습니다.
     */
